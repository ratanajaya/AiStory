...
import { clearAiApiLogs, subscribeToAiApiLogs } from '@/lib/aiApiLog';
    ...
    <>
      ...
      >
        <div className="flex items-center justify-between border-b border-border p-4">
          ...
          <button onClick={onClose} className="rounded p-1 hover:bg-muted" aria-label="Close AI API logs">
        ...
        <div className="min-h-0 flex-1 overflow-y-auto p-3">
          ...
          {selectedEntry && (
            <section className="mt-4 rounded-md border border-border bg-background p-3">
              <h3 className="mb-3 font-semibold">Call details</h3>
